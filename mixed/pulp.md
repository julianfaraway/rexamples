...
|:----------------------------------------|-----------:|-----------:|-----------:|-----------:|-----------:|----------:|
| Precision for the Gaussian observations |     6.8948 |     2.1318 |     3.4895 |     6.6403 |     11.802 |    6.1566 |
| Precision for operator                  | 19637.0029 | 19966.8747 |  1323.4220 | 13610.0575 |  72688.239 | 3613.5751 |
...
```
    ...
    Fixed effects:
                mean    sd 0.025quant 0.5quant 0.975quant mode  kld
    (Intercept) 60.4 0.305     59.783     60.4     61.017 60.4 0.07

    Model hyperparameters:
                                             mean    sd 0.025quant 0.5quant 0.975quant  mode
    Precision for the Gaussian observations 10.62  3.52      5.108    10.16      18.82 9.284
    Precision for operator                  13.52 23.59      0.404     6.46      70.43 0.903
...
```
    ...
    sigalpha   0.50356 0.3863   0.11947    0.25521   0.39091  0.62005   1.5503     0.25535
    sigepsilon 0.31959 0.053582 0.23113    0.28125   0.31344  0.35164   0.44087    0.30054
...
|:----|---------:|--------:|-----------:|---------:|-----------:|---------:|--------:|
| a   | -0.13028 | 0.31888 |   -0.79099 | -0.11933 |    0.48707 | -0.08682 | 0.05978 |
| b   | -0.27675 | 0.32380 |   -0.96323 | -0.26085 |    0.31768 | -0.23370 | 0.05664 |
| c   |  0.17909 | 0.32023 |   -0.43064 |  0.16598 |    0.84846 |  0.13514 | 0.05881 |
| d   |  0.22778 | 0.32165 |   -0.37375 |  0.21281 |    0.90541 |  0.18604 | 0.05810 |
...
```
    ...
    Model hyperparameters:
                                             mean   sd 0.025quant 0.5quant 0.975quant mode
    Precision for the Gaussian observations 10.65 3.52       5.10    10.21      18.79 9.36
    Precision for operator                  11.01 9.13       1.57     8.54      35.08 4.36
...
```
               ...
               mean    sd       quant0.025 quant0.25 quant0.5 quant0.75 quant0.975 mode   
    sigalpha   0.37793 0.16167  0.16957    0.26446   0.3412   0.45161   0.7922     0.28156
    sigepsilon 0.31909 0.053698 0.23128    0.28062   0.31261  0.35099   0.44137    0.29863
...
```
    ...
    Model hyperparameters:
                                             mean    sd 0.025quant 0.5quant 0.975quant mode
    Precision for the Gaussian observations 10.53  3.54       5.04    10.06      18.81 9.15
    Precision for operator                  26.25 36.25       2.24    15.45     117.23 5.80
...
```
               ...
               mean    sd       quant0.025 quant0.25 quant0.5 quant0.75 quant0.975 mode   
    sigalpha   0.28585 0.14828  0.092886   0.18035   0.25428  0.35529   0.66213    0.19807
    sigepsilon 0.32119 0.054356 0.23119    0.2823    0.31506  0.35376   0.44399    0.30233
...
```
    ...
    Samples were drawn using NUTS(diag_e) at Fri Jul  8 14:07:39 2022.
...
```
    ...
    sd(Intercept)     0.62      0.64     0.06     2.41 1.17       15       50

    Population-Level Effects: 
              Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    Intercept    60.30      0.39    59.30    60.92 1.17       15        5

    Family Specific Parameters: 
          Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma     0.35      0.07     0.25     0.52 1.05       58     5394
